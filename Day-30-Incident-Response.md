...
1. Preparation
   - Establish policies, tools, and response plans

2. Identification
   - Detect and verify a security incident

3. Containment
   - Limit the attacker's ability to cause damage

4. Eradication
   - Remove malicious artifacts and attacker access
